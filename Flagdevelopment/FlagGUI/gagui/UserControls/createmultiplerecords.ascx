<%@ Control Language="c#" AutoEventWireup="false" Inherits="GASystem.CreateMultipleRecords" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
    ...
    <tr><td class="EditFormHeaderContainer">
        ...
        <tr>
            <td align="right" class="EditFormHeader_content_aboveflip" colspan="2" >
                <asp:hyperlink CssClass="FlagLinkButton" id="HelpLink" runat="server" Target="_blank">-help link-</asp:hyperlink>
            </td>
        </tr>
        
        <tr><td colspan="2">
        
        <asp:Label id="lblAddGroup" runat="server">Label</asp:Label>
        </td></tr>
        
        <tr>
            <td style="width : 8px; vertical-align : top; "><img align="top" src="images/elementer/flipp.gif" /></td>
            <td class="EditFormHeader_content" style="text-align : right;" ><asp:HyperLink  CssClass="FlagLinkButton" id="ProcedureLink" runat="server"  CausesValidation="False"></asp:HyperLink></td>
        </tr>
        ...
        <asp:TableRow ID="TableRow1" runat="server">
            <asp:TableCell ID="TableCell1" runat="server" CssClass="EditFormHeader_helptext" ><asp:Label CssClass="classHelpText" ID="classHelpText" runat="server"></asp:Label>
