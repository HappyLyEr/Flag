<%@ Control Language="c#" AutoEventWireup="false" Inherits="GASystem.UserControls.EditArcLinksAccessRoles" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
...
<asp:PlaceHolder id="TestOutput" runat="server"></asp:PlaceHolder><BR>
<asp:CheckBox id="SaveCascadingCheckBox" runat="server" Checked="False"></asp:CheckBox>
