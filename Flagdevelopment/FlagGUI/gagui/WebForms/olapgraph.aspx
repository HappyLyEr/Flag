<%@ Page Language="C#" AutoEventWireup="true" Inherits="GASystem.WebForms.OLAPGraph" %>
...
<tr><td valign="top" height="100%">
    ...
    <TABLE cellspacing="4" class="contentmaster" cellpadding="0" width="100%" border="0">
      <tr>
      ...
      <tr valign="top">
        ...
        <td id="dnn_ContentPane" class="contentpanetd" valign="top" align="center"><div class="contentpane"></div><a name="2017"></a>
...
<div id="dnn_ctr2017_ModuleContent">
    ...
    <tbody>
        <tr>
            ...
            <div class="FlagContext_SubCaptionFlagClass">Pivot Graph</div>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div>
        <uc1:CubeGraph id="CubeGraph1" runat="server">
        </uc1:CubeGraph></div>
        ...
        <td id="dnn_RightPane" valign="top" align="center"><div class="rightpane"></div></td>
