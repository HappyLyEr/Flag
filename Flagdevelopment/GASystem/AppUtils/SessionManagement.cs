...
namespace GASystem.AppUtils
{
	...
	//	private static string _currentSkeltaDesignerKey ="CurrentSkeltaDesignerContext";
		...
		public static GADataClass DefaultContextClass
		{
			...
			{
				//return "localhost"; 
				return  GADataRecord.ParseGADataClass(System.Configuration.ConfigurationManager.AppSettings.Get("DefaultContextClass"));
			}	
		}
		...
		public static int DefaultContextRowId
		{
			get 
			{
                return int.Parse(System.Configuration.ConfigurationManager.AppSettings.Get("DefaultContextRowId"));
			}	
		}
