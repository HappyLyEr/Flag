...
namespace GASystem.AppUtils.LookupFilterGenerator
{
	...
	public class LookupFilterFactory
	{
        ...
        public enum LookupFilterType { general, owner, ownerfilter, siblingfilter, siblingfilteralllevels, personnelLogin, followupaction, current, currentInLookupTable}
           ...
           if (lookupFilter == string.Empty)
            ...
            switch (getLookupFilterType(lookupFilter))
            {
                ...
                case LookupFilterType.siblingfilter:
                    return new SiblingLookupFilter(dataClass, owner, lookupFilter, field);
