...
namespace GASystem.BusinessLayer.FlagReport.Impl
{
	...
	/// </summary>
	public class CrystalReport : AbstractFlagReport
	{
		private GASystem.BusinessLayer.GAReport gaReport;
		
		public CrystalReport(ReportDescripton rd, string TempPath) : base(rd, TempPath)
		{
			
		}

		public CrystalReport(ReportDescripton rd, string TempPath, GADataRecord DataRecord) : base(rd, TempPath)
		{
