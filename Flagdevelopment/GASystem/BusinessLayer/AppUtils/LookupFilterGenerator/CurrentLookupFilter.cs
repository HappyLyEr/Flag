...
namespace GASystem.AppUtils.LookupFilterGenerator
{
    ...
    /// </summary>
    class CurrentLookupFilter : GeneralLookupFilter
    {
        ...
        // Tor 20140105 main parts of method below is copied from SiblingLookupFilter
        public CurrentLookupFilter(GADataClass dataClass, GADataRecord owner, string lookupFilter, string field)
		{
            try
            {
...
//                setSiblingOwner(LookupOwner, "CheckDates");
                ...
                string filter = string.Format(_CURRENT_WHERE_STATEMENTBASE
                    , field // Tor 20140908  replaces: , _lookupFieldFd.LookupTable.Substring(2) + "rowid"
                    , _siblingField
