...
{
    public class GridDateTimeItemEditorTemplate : System.Web.UI.IBindableTemplate
    {
        //Label datoDisplay;
        string _formatString;
        string _columnName;
        RadDateTimePicker datePicker;


        public GridDateTimeItemEditorTemplate(string formatString, string columnName) 
        {
        ...
        {
            RadDateTimePicker l = (RadDateTimePicker)sender;
        ...
        public System.Collections.Specialized.IOrderedDictionary  ExtractValues(System.Web.UI.Control container)
        {
            ...
            if (myControl != null)
                od.Add(_columnName, ((RadDateTimePicker)myControl).SelectedDate);
