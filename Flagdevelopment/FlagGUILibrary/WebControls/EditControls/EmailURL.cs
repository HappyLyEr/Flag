...
namespace GASystem.WebControls.EditControls
{
	...
	/// </summary>
    [ValidationPropertyAttribute("EmailAddress")]
    public class EmailURL : System.Web.UI.WebControls.WebControl, INamingContainer
	{
        ...
        public string Text
        {
            get 
            {
                ...
                return "<a href=\"mailto:" + txtBoxURL.Text + "\">" + txtBoxDesc.Text + "</a>"; //txtBoxURL.Text + "#" + txtBoxDesc.Text; 


            }
            set
            {
                string tmparef = value.Replace("<a href=\"mailto:", "");
