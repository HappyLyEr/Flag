...
namespace GASystem.WebControls.EditControls
{
	...
	{
		private Telerik.WebControls.RadDateTimePicker _calendar;
    ...
    //    private short tabIndex = 0;
		...
		public DateTime Value 
		{
			get
			{
                //DateTime selectedDateTime = _calendar.SelectedDate.Date;
...
//			txtBoxTime.TextChanged += new EventHandler(txtBoxTime_TextChanged);
			...
			_calendar = new Telerik.WebControls.RadDateTimePicker();
            _calendar.Calendar.Skin = "FlagCalendar";
            _calendar.TimeView.Skin = "FlagCalendar";
            _calendar.TimeView.StartTime = new TimeSpan(6, 0, 0);
            _calendar.TimeView.EndTime = new TimeSpan(20, 0, 0);
            _calendar.TimeView.Interval = new TimeSpan(0, 15, 0);
