...
namespace GASystem.GUIUtils.DataFilter.EditElements
{
	...
	/// </summary>
	public class LocalizedLabelEditWebControl :IEditWebControl, System.Web.UI.INamingContainer
	{
        ...
        public LocalizedLabelEditWebControl(FieldDescription fd)
		{
		...
		protected override void OnInit(EventArgs e)
		{
            ...
            if (_fd.TableId.ToUpper() == GASystem.DataModel.GADataClass.GAActionWorkitemView.ToString().ToUpper() ||
                _fd.TableId.ToUpper() == GASystem.DataModel.GADataClass.GAWorkitem.ToString().ToUpper())
        ...
        {
            if (_fd.FieldId.ToUpper() == "WORKITEMSTATUS")
                return getWorkitemStatuses();
            if (_fd.FieldId.ToUpper() == "WORKITEMTYPE")
                return getWorkitemTypes();

            return new ArrayList();
        }

        private ArrayList getWorkitemTypes()
        {
            ArrayList list = new ArrayList();

            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemType.Remedial.ToString()), Workitem.WorkitemType.Remedial.ToString()));
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemType.Info.ToString()), Workitem.WorkitemType.Info.ToString()));
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemType.Default.ToString()), Workitem.WorkitemType.Default.ToString()));
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemType.Approve.ToString()), Workitem.WorkitemType.Approve.ToString()));
        ...
        private ArrayList getWorkitemStatuses()
        {
            ArrayList list = new ArrayList();

            //Workitem.WorkitemStatus.
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemStatus.Active.ToString()), Workitem.WorkitemStatus.Active.ToString()));
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemStatus.Completed.ToString()), Workitem.WorkitemStatus.Completed.ToString()));
            list.Add(new ListItem(GASystem.AppUtils.Localization.GetGuiElementText(Workitem.WorkitemStatus.ProceedPending.ToString()), Workitem.WorkitemStatus.ProceedPending.ToString()));
