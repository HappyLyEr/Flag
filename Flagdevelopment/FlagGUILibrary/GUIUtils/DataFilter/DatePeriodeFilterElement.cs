...
namespace GASystem.GUIUtils.DataFilter
{
	...
	/// </summary>
	public class DatePeriodeFilterElement : GeneralFilterElement
	{
...
//		}
        ...
        public DatePeriodeFilterElement(FieldDescription fd)
		{
			
			_editWebControl = new DatePeriodeEditWebControl(fd);
            _viewWebControl = new DatePeriodeViewWebcontrol(fd);
