...
namespace GASystem.GAControls.ListData
{
	...
	/// </summary>
	public class ListClassByOwner : System.Web.UI.WebControls.WebControl
	{
        private static readonly ILog _logger = LogManager.GetLogger(typeof(ListClassByOwner));
        ...
        public ListClassByOwner(GADataClass DataClass, GADataRecord Owner)
		{
			myOwner = Owner;
		...
		protected override void OnInit(EventArgs e)
		{
			...
			try
			{
               ...
               //end test  ***************************************
                ...
                myListDataRecords.DisplayEditButton = Security.HasUpdatePermissionInArcLink(myDataClass, myOwner); //this.DisplayEditButton;
                myListDataRecords.DisplayNewButton = Security.HasCreatePermission(myDataClass, myOwner); //this.DisplayNewButton;
...
//				myListDataRecords.NewRecordClicked += new GACommandEventHandler(myListDataRecords_NewRecordClicked);
		...
		protected override void OnLoad(EventArgs e)
		{
           ...
           // my
            ...
            myListDataRecords.DisplayEditButton = Security.HasUpdatePermissionInArcLink(myDataClass, myOwner);
            myListDataRecords.DisplayNewButton = Security.HasCreatePermission(myDataClass, myOwner);
