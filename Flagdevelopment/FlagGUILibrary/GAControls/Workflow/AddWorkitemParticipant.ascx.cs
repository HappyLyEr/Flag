namespace GASystem.GAControls.Workflow
{
	...
	/// </summary>
	public class AddWorkitemParticipant : System.Web.UI.UserControl
	{
		protected System.Web.UI.WebControls.Panel Panel1;
		protected System.Web.UI.WebControls.Label lblPerson;
		protected System.Web.UI.WebControls.Button LinkButton1;
		protected System.Web.UI.WebControls.Label lblAddParticipantHeader;
		protected System.Web.UI.WebControls.DropDownList ddRoles;
		protected System.Web.UI.WebControls.Button btnSave;
        protected System.Web.UI.WebControls.TextBox addComment;
		protected System.Web.UI.WebControls.PlaceHolder PlaceHolderAddParticipant;
		protected GASystem.RelatedDataRecordField RelatedDataRecordField1;
		...
		private void AddResponsibleControl() 
		{
			...
			this.PlaceHolderAddParticipant.Controls.Add(resp);
		...
		private void btnSave_Click(object sender, System.EventArgs e)
		{
			...
			{
                GASystem.BusinessLayer.Workitem.addParticipantPerson(WorkitemId, int.Parse(resp.getResponsibleId()), addComment.Text);
			} 
			else
			{
				try 
				{
                    ...
                    GASystem.BusinessLayer.Workitem.AddRoleParticipant(WorkitemId, int.Parse(resp.getResponsibleId()), addComment.Text);
				} 
				catch (Exception ex) 
				{
					//TODO log
